...
WHEN I view the source code //fin
THEN I find semantic HTML elements //fin
WHEN I view the structure of the HTML elements
THEN I find that the elements follow a logical structure independent of styling and positioning //fin
WHEN I view the icon and image elements //fin
THEN I find accessible alt attributes //fin
WHEN I view the heading attributes //fin
THEN they fall in sequential order // fin
WHEN I view the title element //fin
THEN I find a concise, descriptive title //fin
```
